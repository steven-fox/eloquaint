...
/**
 * Attribute for defining HasManyThrough relationships.
 *
 * This attribute can be applied to classes or properties to define
 * a has-many-through relationship with another model.
 *
 * @example
 * ```php
...
final readonly class HasManyThrough implements RelationshipAttribute
{
    /**
     * Create a new HasManyThrough attribute.
     *
